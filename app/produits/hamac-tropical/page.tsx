      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="relative aspect-square rounded-xl overflow-hidden shadow-lg">
            <Image
              src="https://plus.unsplash.com/premium_photo-1661329898868-d69f8f40fbaf?q=80&w=3540&auto=format&fit=crop"
              alt="Hamac Tropical"
              fill
          ...
          <div className="flex flex-col">
            ...
            <div className="prose prose-lg mb-8">
              <p className="text-gray-700">
                Notre Hamac Tropical est la parfaite alliance entre confort, style et responsabilité environnementale. 
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
              ...
              <ul className="space-y-3">
                <li className="flex justify-between">
                  ...
                  <span className="font-medium">200 x 160 cm</span>
                </li>
                <li className="flex justify-between">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-medium">Tissus upcyclés, structure en bois</span>
                </li>
                <li className="flex justify-between">
