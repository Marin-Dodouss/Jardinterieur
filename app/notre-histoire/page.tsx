      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12">
          ...
          <div className="w-full md:w-2/3">
            <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-green-800">Notre Histoire</h1>
        ...
        {/* Contact Section */}
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mt-12">
          <h2 className="text-2xl font-bold mb-6 text-green-800">Me Contacter</h2>
          <div className="flex items-center justify-center">
            <a
              href="mailto:contact@jardinterieur.fr"
              className="inline-flex items-center gap-2 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors text-lg"
            >
